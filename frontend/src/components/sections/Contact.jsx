...
// Remplace par ton vrai numéro WhatsApp (format international sans +)
...
export default function Contact() {
  ...
  const INFOS = [
    { t:"Zone", v:"Biganos & Bassin d'Arcachon (33)" },
    { t:'Enfants', v:'4 à 14 ans · max 3 simultanément' },
    { t:'Disponibilités', v:'Mercredis, week-ends, vacances' },
    { t:'Paiement', v:'Virement · CESU' },
  ]
