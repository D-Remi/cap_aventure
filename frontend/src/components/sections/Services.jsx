          ...
          {SVCS.map(v=>(
            <div key={v.title} className="svc-card">
              ...
              <div className="svc-card__body">
                <span className="svc-card__icon">{v.icon}</span>
