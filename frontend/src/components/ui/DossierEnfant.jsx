  ...
  return (
    <div className="dossier">
      ...
      {child.dossier_complete ? (
          ...
          <div className="dossier__blocs">
            {child.centres_interet && (
              <div className="dossier__bloc">
                <div className="dossier__bloc-title"><span></span> CENTRES D'INTÉRÊT & CANAUX D'ATTENTION</div>
                <p>{child.centres_interet}</p>
                {child.activites_a_eviter && <p className="dossier__avoid">À éviter : {child.activites_a_eviter}</p>}
              </div>
            )}
            {child.declencheurs_crise && (
              <div className="dossier__bloc dossier__bloc--warning">
                <div className="dossier__bloc-title"><span></span> FACTEURS DÉCLENCHEURS DE CRISE / SURCHARGE</div>
        ...
        <div className="dossier__incomplete"><span></span><p>Le dossier complet n'a pas encore été rempli par les parents.</p></div>
      )}
