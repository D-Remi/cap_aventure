...
function header(doc, sousTitre) {
  ...
  doc.setFontSize(9)
  doc.text('Service de garde d\'enfant • Haute-Savoie (74)', 14, 23)
  doc.setFontSize(8)
...
function footer(doc) {
  ...
  doc.setFont('helvetica', 'normal')
  doc.setFontSize(7.5)
  doc.text('Éduc & Vous • Haute-Savoie (74) • Virement et CESU acceptés • SIRET : __________', 105, h - 13, { align: 'center' })
...
export function genererFacturePDF(facture, contrat, user, seances = []) {
  ...
  doc.text(['Éduc & Vous', 'Haute-Savoie (74)', 'contact@educetvous74.fr'], 14, y + 5)
  doc.text([
