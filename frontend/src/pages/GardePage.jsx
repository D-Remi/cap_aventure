          ...
          <div className="container service-page__hero-inner">
            <div>
              ...
              <div className="service-page__hero-btns">
                ...
                <a href="#" onClick={e=>{e.preventDefault();setShowContact(true)}} className="btn-secondary">Me contacter</a>
              </div>
            </div>
            ...
            <div className="service-info-grid">
              <div>
                ...
                <div className="service-info-list">
                  ...
                  <div className="service-info-row"><span></span><div><strong>Disponibilités</strong><span>Mercredis, week-ends et vacances scolaires</span></div></div>
