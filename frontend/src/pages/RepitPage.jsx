        ...
        <div className="container">
          ...
          <section className="service-section">
            ...
            <div className="service-cards">
              {[
                { i:'🤝', t:'Échange préalable approfondi', d:'Avant le premier accueil, nous échangeons sur les habitudes, déclencheurs, méthodes d\'apaisement et centres d\'intérêt de votre enfant.' },
                ...
                { i:'⏸️', t:'Rythme respecté', d:'Pas de contrainte de temps. Si l\'enfant a besoin de pauses ou de calme, on s\'adapte.' },
            ...
            <div className="service-info-grid">
              <div>
                ...
                <div className="service-info-list">
                  ...
                  <div className="service-info-row"><span>🗓️</span><div><strong>Fréquence</strong><span>Ponctuelle ou régulière selon vos besoins</span></div></div>
